...
$nkl = $conexion -> prepare("UPDATE contactos SET nombre=:nombre,apellido=:apellido,cedula=:cedula,telefono=:telefono,direccion=:direccion,fecha=:fecha WHERE id=:txtid");

$nkl -> bindParam(":nombre",$nombre);
$nkl -> bindParam(":apellido",$apellido);
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
              ...
              <label style="font-weight: bold;" for="nombre" class="text-white">Nombre:</label>
               <input type="text" class="form-control" name="nombre" value="<?php echo $nombre; ?>" placeholder="ingrese su nombre">
                ...
                <div class="form-group">
              <label style="font-weight: bold;" for="apellido" class="text-white">Apellido:</label>
               <input type="text" class="form-control" name="apellido" value="<?php echo $apellido; ?>" placeholder="ingrese su apellido">
                </div>
